...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
        <div class="kt-portlet__body">
            <form class="kt-form kt-form--label-right" action="<?= $app->router()->getRoute('admin_product_edit',['id'=>$product['id']]) ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" value="<?= $product['product_type_id'] ?>" id="formProductCategorySelected">
                <div class="kt-portlet__body">
                        ...
                        <div class="col-2">
                            <select class="form-control" name="formProductUserId">
                                ...
                                foreach($users as $user){
                                    ?>
                                    <option <?php if($product['user_id'] == $user['id']){echo'selected';} ?> value="<?= $user['id']?>"><?= $user['first_name'] ." ". $user['last_name'] ?></option>
                                    <?php
                                }
                                ?>
                            </select>
