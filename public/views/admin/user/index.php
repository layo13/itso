						...
						<div class="kt-widget__content">
							<div class="kt-widget__head">
								...
								<div class="kt-widget__action">
									<a href="<?= $app->router()->getRoute('admin_user_view',['id'=>$user['id']]) ?>" class="btn btn-facebook btn-sm btn-upper">Détail</a>&nbsp;
									<a href="<?= $app->router()->getRoute('admin_user_update',['id'=>$user['id']]) ?>" class="btn btn-dark btn-sm btn-upper">Modifier</a>
                                    <?php
                                    if($user['active'] == 1){
                                        ?>
							...
							<div class="kt-widget__subhead">
								...
								<a href="#"><i class="flaticon2-calendar-3"></i><?= $user['user_type_name'] ?></a>
					...
					<div class="kt-widget__bottom">
                        ...
                        <div class="kt-widget__item">
                            ...
                            <div class="kt-widget__details">
                                ...
                                <span class="kt-widget__value"><?= $user['day_of_birth'] ?></span>
                            </div>
                        </div>
					</div>
				</div>
