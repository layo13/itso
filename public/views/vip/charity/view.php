        ...
        <div class="kt-widget kt-widget--user-profile-3">
            <div class="kt-widget__top">
                <div class="kt-widget__media">
                    ...
                    ?>
                    <img src="<?= $url ?>public/assets/images/charity/<?= $charityPictureUrl ?>" alt="image">
                </div>
                <div class="kt-widget__content">
                    <div class="kt-widget__head">
                        ...
                        <div class="kt-widget__action">
                            <a href="<?= $app->router()->getRoute('vip_charity_update',['id' => $charity['id']]) ?>" class="btn btn-label-danger btn-sm btn-upper">Modifier</a>
                        </div>
                    </div>
                </div>
            </div>
