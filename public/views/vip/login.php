...
<html lang="en">
	...
	<head>
		...
		-->
		<meta charset="utf-8" />
		<title>In the shoes of - connexion</title>
		...
		<link href="<?= $url ?>/public/assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
			<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(<?= $url ?>/public/assets/images/background_1.jpg
                        );">
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="<?= $url ?>/public/assets/images/logo_rond.png">
								</a>
							</div>
							<div class="kt-login__signin">
								...
								<form class="kt-form" method="post" action="<?= $url ?>vip/login">
